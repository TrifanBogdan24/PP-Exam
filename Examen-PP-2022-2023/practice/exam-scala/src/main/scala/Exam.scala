...
object Exam {
  ...
  /*
 cu valori intre 1 si 255, si o masca reprezentata ca o lista de liste de valori
      0,1. Este garan     6. [Mediu]
      Implementati o functie care primeste o imagine reprezentata ca o lista de liste
      de int tat faptul ca valorile 1 dintr-o masca descriu un dreptunghi.
